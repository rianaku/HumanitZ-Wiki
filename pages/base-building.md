...
## <span style="color:#E79543;">1. Choosing a Location</span>

<div style="background:#111; padding:16px; border:1px solid #333; border-radius:8px;">

When picking a base spot, consider:

- **Access** – near good loot routes but not in the middle of them.
- **Defensibility** – choke points, fences, limited entry paths.
- **Escape routes** – you need backup exits.
- **Vehicle space** – future-proof for garages and parking.
- **Farming potential** – open ground or nearby plots.

</div>

---

## <span style="color:#E79543;">2. Base Types</span>

<details>
<summary><strong style="color:#E79543;">🏚️ Safe House</strong></summary>
...
<details>
<summary><strong style="color:#E79543;">🏰 Fortified Base</strong></summary>
...
<details>
<summary><strong style="color:#E79543;">🧭 Outposts / Forward Camps</strong></summary>
...
## <span style="color:#E79543;">3. Materials & Upgrade Paths</span>
...
## <span style="color:#E79543;">4. Core Base Modules</span>
...
## <span style="color:#E79543;">5. Defensive Design</span>
...
Add specifics as the building system is tested more (what zeeks can/can’t break, etc.).

---

<p align="center" style="color:#555; font-size:13px;">
See also <a href="Loot-Crafting.md" style="color:#E79543;">🔧 Loot & Crafting</a> • <a href="Map-&-Environments.md" style="color:#E79543;">🗺️ Map & Environments</a>
</p>
